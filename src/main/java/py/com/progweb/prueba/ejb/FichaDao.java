...
public class FichaDao {
    ...
    /*  JSONObject obj=especialidad.toJson();
     ...
     public Ficha GetFichaPorPacienteIdGet(int id) {
        Query q = this.em.createQuery("select f from Ficha f where f.paciente.id =:id ")
                .setParameter("id", id);
        return (Ficha) q.getSingleResult();
    }
     
     public List<Detalle> GetFichaPorEspecialidad(String especialidad) {
        Query q = this.em.createQuery("select d from Detalle d where d.medico.especialidad =:especialidad ")
                .setParameter("especialidad", especialidad);
       
        return (List<Detalle>) q.getResultList();
    }
     
     public List<Detalle> GetFichaPorCedulaMedico(String cedula) {
        Query q = this.em.createQuery("select d from Detalle d where d.medico.cedula =:cedula")
                .setParameter("cedula", cedula);
       
        return (List<Detalle>) q.getResultList();
    }
     
    public List<Detalle> GetFichaPorCedulaPaciente(String cedula) {
        Query q = this.em.createQuery("select d from Detalle d where d.ficha.paciente.cedula =:cedula")
                .setParameter("cedula", cedula);
    ...
    public List<Ficha> GetFichaPorPacienteIdMedicoCedula(int id,String cedula) {
        Query q = this.em.createQuery("select d from Detalle d where d.ficha.paciente.id =:id and d.medico.cedula=:cedula")
                .setParameter("id", id)
                .setParameter("cedula",cedula);
     ...
     public List<Ficha> GetFichaPorPacienteCedulaMedicoId(String cedula,int id) {
        Query q = this.em.createQuery("select d from Detalle d where d.ficha.paciente.cedula =:cedula and d.medico.id=:id")
                .setParameter("cedula", cedula)
                .setParameter("id",id);
    ...
    public List<Detalle> GetFichaPorMedicoId(int id) {
        Query q = this.em.createQuery("select d from Detalle d where d.medico =:id")
                .setParameter("id", id);
